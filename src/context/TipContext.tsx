...
export const TipProvider = ({ children }: { children: ReactNode }) => {
  const [tips, setTips] = useState<Tip[]>([
    ...
    },
    {
      ...
      recipient: 'Sam',
      amount: 8,
      note: 'Thanks for setting up that intro meeting with the VP of Sales!',
    ...
    },
    {
      ...
      recipient: 'Jordan',
      amount: 12,
      note: 'Always responsive on LinkedIn - you\'re the best!',
    ...
    },
    {
      ...
      recipient: 'Harper',
      amount: 25,
      note: 'Thanks for all your help with the enterprise pitch deck!',
    ...
    },
    {
      ...
      recipient: 'Quinn',
      amount: 7,
      note: 'You always follow up with the right information at the right time!',
